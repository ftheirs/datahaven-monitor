...
export async function runHelloWorld(): Promise<void> {
	...
	console.log(
		"[sanity/helloWorld] StorageHub Core module keys:",
		Object.keys(StorageHubCore),
	);
	// eslint-disable-next-line no-console
	console.log(
		"[sanity/helloWorld] StorageHub MSP Client module keys:",
		Object.keys(StorageHubMspClient),
	);
}
